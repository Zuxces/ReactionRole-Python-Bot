...
## Setup
- Clone the repository using `git clone https://github.com/Zuxces/ReactionRole-Python-Bot
.git` (or download it as a `*.zip` file and extract it - it is recommended to use git instead of the zip archive)
...
## Updating
You can view new features in the [changelog](https://github.com/Zuxces/ReactionRole-Python-Bot/README.md).
...
## Roadmap
Upcoming features can be found in the open issues and PRs tagged with **new feature**. They can be found [here](https://github.com/Zuxces/ReactionRole-Python-Bot
).
